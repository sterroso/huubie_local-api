...
export function createEmployee(
  ...
  const employee = {
    ...
    study: faker.lorem.word({
      length: { min: 3, max: 30 },
      strategy: "closest",
    }),
    id_document_type: faker.lorem.word({
      length: { min: 3, max: 20 },
      strategy: "closest",
    }),
    id_document_number: faker.lorem.word({
      length: { min: 3, max: 20 },
      strategy: "closest",
    }),
    citizen_id_number: faker.lorem.word({
      length: { min: 3, max: 20 },
      strategy: "closest",
    }),
    ssn: faker.lorem.word({ length: { min: 5, max: 20 }, strategy: "closest" }),
    ssn_issue_date: faker.date.anytime().toISOString().slice(0, 10),
    pay_cadence: faker.lorem.word({
      length: { min: 3, max: 10 },
      strategy: "closest",
    }),
    daily_wage: 249.0,
    attendance_bonus: 5500.0,
    other_bonus: 1800.0,
    incentives: 1550.0,
    complimentary_payroll: 1800.0,
    regular_payroll: 7468.0,
  ...
  const shifts = [
    {
      ...
      end_time: "1970-01-01 14:00:00.000",
    },
    {
      name: "Vespertino",
      start_time: "1970-01-01 14:00:00.000",
      end_time: "1970-01-01 21:00:00.000",
    },
    {
      name: "Nocturno",
      start_time: "1970-01-01 21:00:00.000",
      end_time: "1970-01-01 04:00:00.000",
    },
  ];
